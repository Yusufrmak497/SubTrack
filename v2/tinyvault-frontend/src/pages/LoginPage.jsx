      ...
      <div className="auth-card">
        ...
        <div className="auth-demo-accounts">
          ...
          <div className="demo-rows">
            <div className="demo-row" onClick={() => { setUsername('admin_rojhat'); setPassword('admin123') }}><span className="role-badge role-admin">Admin</span><span>admin_rojhat / admin123</span></div>
            <div className="demo-row" onClick={() => { setUsername('demo_user'); setPassword('user123') }}><span className="role-badge role-user">User</span><span>demo_user / user123</span></div>
            <div className="demo-row" onClick={() => { setUsername('demo_viewer'); setPassword('viewer123') }}><span className="role-badge role-viewer">Viewer</span><span>demo_viewer / viewer123</span></div>
          </div>
        </div>
      </div>
    </div>
